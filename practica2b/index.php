...
<head>
    ...
    <title>Practica 2b</title>
</head>
<body>
    <h1>Practica No.2b </h1>
    ...
    <form action="index.php" method="POST">
        <button type="submit" name="boton" value="boton_alimentos">A. Menú de Alimentos</button>
        <button type="submit" name="boton" value="boton_bebidas">B. Menú de Bebidas</button>
    </form>
    <hr>
